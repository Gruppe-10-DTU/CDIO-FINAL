...
public class Player {
     ...
     */
    public Player(int iD, String name, java.lang.Character character){
        this.iD = iD;
        this.identifier = name;
     ...
     */
    public Player(int iD, String name, int startingBalance, java.lang.Character character){
        this.iD = iD;
        identifier = name;
     ...
     */
    public Player(int iD, String name, int startingBalance, java.lang.Character character, int soldSign){
        this.iD = iD;
        identifier = name;
        balance = new Balance(startingBalance);
        this.character = character;
